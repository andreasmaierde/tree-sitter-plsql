...
module.exports = grammar({
    ...
    rules: {
        ...
        sub_av_clause: $ => seq(
            $.kw_using,
            $.referenced_element,
            optional($.hierachies_clause),
            optional($.filter_clauses),
            optional($.add_meas_clause),

        ),
        hierachies_clause: $ => seq(
            $.kw_hierarchies,
            $.referenced_element,
            BRACKET_LEFT,
        ...
        base_meas_clause: $ => seq(
            $.kw_fact,
            $.kw_for,
            $.kw_measure,
            $.identifier,
            $.meas_aggrecate_clause,
        ),
        meas_aggrecate_clause: $ => seq(
            $.kw_aggregate,
            $.kw_by,
            $.identifier,
        ),
        ...
        search_clause: $ => seq(
            ...
            $.kw_first,
            $.kw_by,
            repeat1($.search_clause_alias),
            $.kw_set,
            $.identifier,
        ),
        search_clause_alias: $ => seq(
          $.identifier,
          optional(
